...
RUN apk --no-cache add wget gcc make g++ zlib-dev pcre ca-certificates curl net-tools aircrack-ng git bash linux-headers nano libpcap wireless-tools usbutils
